#2020-11-24 (12일차)
#gridsearchCV가 풀네임!(cross validation)
#grid(격자망) search: hyper parameter를 싹 모아서 (여러가지 경우의 수 존재 ex)activation 뭘 사용할지) 채로 거른다 = 촘촘하게 다 잡는다
#전체를 한 방에 다 하겠다 (몽땅 다 넣고 한방에 fit시키겠다)
#분류
