...
model = RandomizedSearchCV(RandomForestClassifier(), parameters, cv=kfold, verbose=2) #괄호 안에 모델명. svc라는 모델을 girdserachcv로 쓰겠다
...
'''
최적의 매개변수:  RandomForestClassifier(max_depth=4, min_samples_split=3, n_estimators=200,
                       n_jobs=-1)
