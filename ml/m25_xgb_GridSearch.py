...
model = GridSearchCV(XGBRegressor(), parameters, cv=kfold, verbose=2)
...
[CV]  colsample=0.9, colsample_bytree=1, learning_rate=0.5, max_depth=6, n_estimators=110, total=   0.0s
[Parallel(n_jobs=1)]: Done 1395 out of 1395 | elapsed:  1.1min finished
...
model.score:  0.9190709701474106
'''
