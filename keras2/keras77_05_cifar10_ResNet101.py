...
#2. 모델
t = ResNet101(weights='imagenet', include_top=False, input_shape=(x_train.shape[1], x_train.shape[2], 3))
...
=================================================================
Total params: 43,252,106
Trainable params: 593,418
Non-trainable params: 42,658,688
_________________________________________________________________
loss:  7.657502174377441
