#2020-12-04
#cifar10 + NASNetMobile


from tensorflow.keras.applications import NASNetMobile, DenseNet201
...
#2. 모델
t = DenseNet201(weights='imagenet', include_top=False, input_shape=(x_train.shape[1], x_train.shape[2], 3))
...
==========cifar10_DenseNet201==========
loss:  2.7568259239196777
acc:  0.6201000213623047
