...
#모델 2(fit 이후에 저장) 로드
#컴파일만 주석처리시 model_test01_1 같은 경우는 에러 난다 (fit 이전에 save했기 때문)
...
'''
fit 이후에 save하면 모델과 가중치가 같이 save
-> 바뀌지 않는 결과를 드디어 찾을 수 있다 
313/313 [==============================] - 1s 2ms/step - loss: 0.0818 - accuracy: 0.9787
loss:  0.08180103451013565
