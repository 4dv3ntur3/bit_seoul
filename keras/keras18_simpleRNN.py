...
from tensorflow.keras.layers import Dense, LSTM, SimpleRNN #LSTM도 layer
...
model = Sequential()
model.add(SimpleRNN(20, activation='relu', input_shape=(3,1))) #이후부터는 동일한 dense층, 넘어가는 노드의 개수가 30개
