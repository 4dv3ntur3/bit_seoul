...
hist = model.fit(x_train, y_train, epochs=100, batch_size=32, verbose=1,
          validation_split=0.2, callbacks=[early_stopping]) #tensorboard 쓰고 싶으면 여기다가 to_hist도...
...
#가중치만 저장
model.save_weights('./save/mnist_cnn_weights.h5')
...
'''
loss:  0.0756116509437561
acc:  0.9807999730110168
